...
class ReverselinkedlistTest {
    ...
    boolean checkSameListNodes(ListNode nodeA, ListNode nodeB) {
    ...
    void reverseList() {
        ...
        ListNode inputHead = initListNode(input);
        ListNode expectedHead = initListNode(expected);


        assertTrue(checkSameListNodes(sol.reverseList(inputHead), expectedHead));
    }
